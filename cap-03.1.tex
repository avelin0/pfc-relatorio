...
\caption{Pseudo código para o passo um do algoritmo de \textit{watershed}.}
\end{algorithm}
...
\caption{Pseudo código para o passo dois do algoritmo de \textit{watershed}.}
\end{algorithm}
...
\caption{Pseudo código para o passo três do algoritmo de \textit{watershed}.}
\end{algorithm}
