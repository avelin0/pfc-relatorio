...
% Figura 
  \begin{figure}[!htb]
   ...
   Pode-se observar pela figura \ref{fig:einsteinlocal} que houve a separação em mais regiões nesse método do que em \ref{fig:einsteinglobal}, já que foi usado um limiar mais apropriado a cada região.
